        ...
        for wld in world_views:
            for lvl in range(4, 0, -1):
                row = {
                    ...
                    "adm": lvl,
                    "date": land_date,
                    "a_parquet": f"{DATA_URL}/{name}/{dest}/{wld}/adm{lvl}_polygons.parquet",
                    ...
                    "l_parquet": f"{DATA_URL}/{name}/{dest}/{wld}/adm{lvl}_lines.parquet",
                    ...
                    "p_parquet": f"{DATA_URL}/{name}/{dest}/{wld}/adm{lvl}_points.parquet",
