...
- These datasets are only intended for use at the global or regional level. For representing a single administrative area, a source should be taken prior to edge modifications being applied, as this is more faithful to the original.
